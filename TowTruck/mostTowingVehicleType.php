...
<?php
      ...
      if (mysqli_connect_errno())     //check connection is establish
       ...
       $sql="SELECT vehicle_type, COUNT(vehicle_type) AS type_count
      ...
      ";
       ...
       <table class="table table-bordered table-dark">
         <tr>
           <td>
             <h1>The most common vehicle type is: </h1><br>
              <h1 style="color: green;"><?php echo $most; ?></h1>
           </td>
         </tr>
       </table>
