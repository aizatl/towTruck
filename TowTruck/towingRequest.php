 ...
 ?>
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="menu-active"><a href="#hero">TOWING REQUEST</a></li>
    ...
    <div class="hero-container">
      <h1> WHAT DO YOU WANT TO DO?</h1>
       <table class="table table-bordered table-dark" style="width: 300px; margin: 0 auto;">
         <thead>
          <tr>
             <th scope="col" style="padding: 30px;"> <a href="addNT.php">NEW TOWING REQUEST<br></a></th>
           </tr>
           <tr>
             <th scope="col" style="padding: 30px;" ><a href="viewNT.php">VIEW EXISTING TOWING REQUEST</a></th>
           </tr>
