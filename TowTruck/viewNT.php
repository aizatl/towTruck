 ...
 ?>
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="menu-active"><a href="#hero">VIEW TOWING REQUEST</a></li>
       ...
       <table class="table table-bordered table-dark">
         <thead>
           ...
           while($row=mysqli_fetch_assoc($res))
           {
             ...
             echo "<td><a href='editTR.php?id=" . $row['Towing_Request_ID']."'>Edit</a></td>";
             echo "<td><a href='deleteTR.php?id=" . $row['Towing_Request_ID']."'>Delete</a></td>";
             $count++;
           }
            ?>
